...
CREATE PROCEDURE ViewJobsArchive_GetByID          
 @JobID INT,      
 @SiteID INT          
AS          
SELECT [JobID]          
  ...
  INNER JOIN [dbo].[ViewJobsArchive] ON ViewJobsArchive.AdvertiserID =  AdvertiserFilter.AdvertiserID         
  WHERE [JobID] = @JobID 
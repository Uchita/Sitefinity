    ...
    public class TestBusinessLogicsConnector : IBusinessLogicsConnector
    {
        ...
        public void InitData()
        {
            ...
            AvailablJobs = new List<JobDetailsFullModel>
            {
                ...
                new JobDetailsFullModel { JobID = 15, Title = "Job Title 1A", Description = "Job Description 1A", ShortDescription = "Short Description 1A", Filters = new List<JobFilterRoot> { Australia_Sydney_Central, Sales_Analyst_Telesales_Causal } },
                new JobDetailsFullModel { JobID = 34, Title = "Job Title 3A", Description = "Job Description 3A", ShortDescription = "Short Description 3A", Filters = new List<JobFilterRoot> { Australia_Sydney_Central_TownHall, Sales_Analyst_Telesales_Causal } },
                new JobDetailsFullModel { JobID = 55, Title = "Job Title 5A", Description = "Job Description 5A", ShortDescription = "Short Description 5A", Filters = new List<JobFilterRoot> { Australia_Melbourne_George, Accounting_AccountantCost_AccountantFinancial } },
                new JobDetailsFullModel { JobID = 78, Title = "Job Title 7A", Description = "Job Description 7A", ShortDescription = "Short Description 7A", Filters = new List<JobFilterRoot> { NZ_Auckland, Accounting_AccountantTax } },
                new JobDetailsFullModel { JobID = 89, Title = "Job Title 9A", Description = "Job Description 9A", ShortDescription = "Short Description 9A", Filters = new List<JobFilterRoot> { Australia_Sydney_Central, Accounting_AccountantCost_AccountantFinancial } },
                new JobDetailsFullModel { JobID = 111, Title = "Job Title 1B", Description = "Job Description 1B", ShortDescription = "Short Description 1B", Filters = new List<JobFilterRoot> { Australia_Sydney_Central_TownHall, Accounting_AccountantCost_AccountantFinancial } },
                new JobDetailsFullModel { JobID = 56, Title = "Job Title 3B", Description = "Job Description 3B", ShortDescription = "Short Description 3B", Filters = new List<JobFilterRoot> { NZ_Auckland, Accounting_AccountantTax } },
                new JobDetailsFullModel { JobID = 28, Title = "Job Title 5B", Description = "Job Description 5B", ShortDescription = "Short Description 5B", Filters = new List<JobFilterRoot> { Australia_Melbourne_George, Accounting_AccountantCost_AccountantFinancial } },
                new JobDetailsFullModel { JobID = 71, Title = "Job Title 7B", Description = "Job Description 7B", ShortDescription = "Short Description 7B", Filters = new List<JobFilterRoot> { Australia_Sydney_Central_TownHall, Sales_Analyst_Telesales_Causal } },
                new JobDetailsFullModel { JobID = 95, Title = "Job Title 9B", Description = "Job Description 9B", ShortDescription = "Short Description 9B", Filters = new List<JobFilterRoot> { NZ_Auckland, Sales_Analyst_Telesales_Causal } }
            };
        }
        ...
        public TestBusinessLogicsConnector()
        {
        }

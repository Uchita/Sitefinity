    ...
    public class TestBusinessLogicsConnector : IBusinessLogicsConnector
    {
        ...
        public void InitData()
        {
            ...
            AvailablJobs = new List<JobDetailsFullModel>
            {
                ...
                new JobDetailsFullModel { JobID = "8", Title = "Job Title 9", Description = "Job Description 9", ShortDescription = "Short Description 9", Filters = new List<JobFilterRoot> { Australia_Sydney_Central, Accounting_AccountantCost_AccountantFinancial } },
                ...
                new JobDetailsFullModel { JobID = "7A", Title = "Job Title 7A", Description = "Job Description 7A", ShortDescription = "Short Description 7A", Filters = new List<JobFilterRoot> { Australia_Sydney_Central, Accounting_AccountantTax } },
                ...
                new JobDetailsFullModel { JobID = "3B", Title = "Job Title 3B", Description = "Job Description 3B", ShortDescription = "Short Description 3B", Filters = new List<JobFilterRoot> { Australia_Sydney_Central, Accounting_AccountantTax } },
                ...
                new JobDetailsFullModel { JobID = "8B", Title = "Job Title 9B", Description = "Job Description 9B", ShortDescription = "Short Description 9B", Filters = new List<JobFilterRoot> { Australia_Melbourne_George_Pitt_Central, Sales_Analyst_Telesales_Causal } }
            };
        }

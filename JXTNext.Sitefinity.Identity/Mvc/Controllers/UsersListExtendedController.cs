...
namespace JXTNext.Sitefinity.Widgets.Authentication.Mvc.Controllers
{
    ...
    /// </summary>
    [ControllerToolboxItem(Name = "UsersListExtended", Title = "Users list Extended", SectionName = "JXTNext.Users", CssClass = UsersListExtendedController.WidgetIconCssClass)]
    [Localization(typeof(UsersListExtendedResources))]
    public class UsersListExtendedController : Controller
    {
        #region Properties
        ...
        public IUsersListExtendedModel Model
        {
            get
            {
                if (this.model == null)
        ...
        /// </returns>
        private IUsersListExtendedModel InitializeModel()
        {
            return ControllerModelFactory.GetModel<IUsersListExtendedModel>(this.GetType());
        }
        ...
        private IUsersListExtendedModel model;

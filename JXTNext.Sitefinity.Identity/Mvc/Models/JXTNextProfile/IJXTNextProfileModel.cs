...
namespace JXTNext.Sitefinity.Widgets.Authentication.Mvc.Models.JXTNextProfile
{
    ...
    /// </summary>
    public interface IJXTNextProfileModel
    {
        /// <summary>
        ...
        /// A view model.
        /// </returns>
        JXTNextProfilePreviewViewModel GetProfilePreviewViewModel();
        ...
        /// A view model.
        /// </returns>
        JXTNextProfileEditViewModel GetProfileEditViewModel();
        ...
        bool EditUserProfile(JXTNextProfileEditViewModel model);
        ...
        bool EditUserEmail(JXTNextProfileEmailEditViewModel model);
        ...
        bool IsEmailChanged(JXTNextProfileEditViewModel model);
        ...
        void InitializeUserRelatedData(JXTNextProfileEditViewModel model, bool emailUpdate = true);
        ...
        void ValidateProfileData(JXTNextProfileEditViewModel viewModel, System.Web.Mvc.ModelStateDictionary modelState);
    }
}

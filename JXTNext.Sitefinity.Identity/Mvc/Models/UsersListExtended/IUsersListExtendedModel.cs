...
namespace JXTNext.Sitefinity.Widgets.Authentication.Mvc.Models.UsersListExtended
{
    ...
    /// </summary>
    public interface IUsersListExtendedModel
    {
        /// <summary>
        ...
        /// The serialized date filters.
        /// </value>
        string SerializedSelectedTaxonItemsIds { get; set; }
        ...
        UsersListExtendedViewModel CreateListViewModel(int page);
        ...
        UserDetailsExtendedViewModel CreateDetailsViewModel(IDataItem item);
        ...
        /// </returns>
        IEnumerable<CacheDependencyKey> GetKeysOfDependentObjects(UsersListExtendedViewModel viewModel);
        ...
        /// The <see cref="IEnumerable"/>.
        /// </returns>
        IEnumerable<CacheDependencyKey> GetKeysOfDependentObjects(UserDetailsExtendedViewModel viewModel);
    }
}

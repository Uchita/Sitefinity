...
using JXTNext.Sitefinity.Widgets.Authentication.Mvc.Models;
...
namespace JXTNext.Sitefinity.Widgets.Authentication.Mvc.Models.UsersListExtended
{
    ...
    public class TaxasUserInfo
    {
        public TrackedList<Guid> TaxanomyIds;
    ...
    /// </summary>
    public class UsersListExtendedModel : IUsersListExtendedModel
    {
        public UsersListExtendedModel()
        {
        ...
        public string SerializedSelectedItemsIds
        {
            ...
            set
            {
                if (this.serializedSelectedItemsIds != value)
                {
                    ...
                    {
                        this.selectedItemsIds = JsonConvert.DeserializeObject<IList<string>>(this.serializedSelectedItemsIds);
                    }
                }
            }
        }
        ...
        public string SerializedAdditionalFilters
        {
            ...
            set
            {
                if (this.serializedAdditionalFilters != value)
                {
                    ...
                    {
                        this.selectedRolesFilter = JsonConvert.DeserializeObject<IList<Role>>(this.serializedAdditionalFilters);
                    }
                }
            }
        }
        ...
        /// The serialized date filters.
        /// </value>
        public string SerializedSelectedTaxonItemsIds
        {
            get
            {
                return this.serializedSelectedTaxaItemsIds;
            }

            set
            {
                if (this.serializedSelectedTaxaItemsIds != value)
                {
                    this.serializedSelectedTaxaItemsIds = value;
                    if (!this.serializedSelectedTaxaItemsIds.IsNullOrEmpty())
                    {
                        this.selectedTaxaItemsIds = JsonConvert.DeserializeObject<IList<string>>(this.serializedSelectedTaxaItemsIds);
                    }
                }
            }
        }
        ...
        public UsersListExtendedViewModel CreateListViewModel(int page)
        {
            if (page < 1)
        ...
        public UserDetailsExtendedViewModel CreateDetailsViewModel(IDataItem item)
        {
        ...
        /// <inheritDoc/>
        public IEnumerable<CacheDependencyKey> GetKeysOfDependentObjects(UserDetailsExtendedViewModel viewModel)
        {
            var contentResolvedType = this.ContentType;
            var result = new List<CacheDependencyKey>(1);
        ...
        protected UsersListExtendedViewModel CreateListViewModelInstance()
        {
            return new UsersListExtendedViewModel();
        }
        ...
        protected UserDetailsExtendedViewModel CreateDetailsViewModelInstance()
        {
            return new UserDetailsExtendedViewModel();
        }
        ...
        protected ItemViewModel CreateItemViewModelInstance(IDataItem item)
        {
            try
            {
                return new SitefinityProfileItemExtendedViewModel(item);
            }
            catch
            {
        ...
        protected IQueryable UpdateExpression(int? skip, int? take, ref int? totalCount)
        {
            ...
            if (this.SelectionMode != SelectionMode.AllItems && compiledFilterExpression.IsNullOrEmpty())
            {
                return null;
            }
            else
        ...
        protected string CompileFilterExpression()
        {
            ...
            else if (this.SelectionMode == SelectionMode.TaxonomyItems)
            {
                var selectedTaxaItemsFilterExpression = this.GetSelectedTaxaItemsFilterExpression();
                if (!selectedTaxaItemsFilterExpression.IsNullOrEmpty())
                {
                    elements.Add(selectedTaxaItemsFilterExpression);
                }
            }
        ...
        private string GetSelectedTaxaItemsFilterExpression()
        {
            ...
            foreach (dynamic profilelinkquery in profileLinksQuery)
            {
                if (IsPropertyExist(profilelinkquery, "Departments"))
                {
                    ...
                    userInfoTaxas.Add(new TaxasUserInfo() { TaxanomyIds = taxaIds, UserInfo = userInfo });
                }
            }
        ...
        private string serializedSelectedTaxaItemsIds;
        private IList<string> selectedTaxaItemsIds = new List<string>();

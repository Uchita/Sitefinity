(function ($) {
    ...
    angular.module('designer').controller('SimpleCtrl', ['$scope', 'propertyService', function ($scope, propertyService) {
        ...
        $scope.$watch(
            'taxaSelector.selectedItemsIds',
            function (newSelectedItemsIds, oldSelectedItemsIds) {
                if (newSelectedItemsIds !== oldSelectedItemsIds) {
                    if (newSelectedItemsIds) {
                        $scope.properties.SerializedSelectedTaxonItemsIds.PropertyValue = JSON.stringify(newSelectedItemsIds);
                    }
                }
            },
            true
        ...
        propertyService.get()
            .then(function (data) {
                if (data) {
                    ...
                    var selectedTaxaItemsIds = $.parseJSON($scope.properties.SerializedSelectedTaxonItemsIds.PropertyValue || null);
                    $scope.taxaSelector.selectedItemsIds = selectedTaxaItemsIds;

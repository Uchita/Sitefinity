...
namespace JXTNext.Sitefinity.Widgets.Authentication.Mvc.StringResources
{
    ...
    /// </summary>
    [ObjectInfo(typeof(UsersListExtendedResources), ResourceClassId = "UsersListExtendedResources", Title = "UsersListExtendedResourcesTitle", Description = "UsersListExtendedResourcesDescription")]
    public class UsersListExtendedResources : Resource
    {
        #region Constructions
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersListResources"/> class.
        /// </summary>
        public UsersListExtendedResources()
        {
        }
        ...
        public UsersListExtendedResources(ResourceDataProvider dataProvider)
            : base(dataProvider)
        {
        }
        #endregion
        ...
        /// phrase: Which profile type to use?
        /// </summary>
        [ResourceEntry("ByDepartment",
            Value = "By Department",
            Description = "phrase: By Department",
            LastModified = "2015/05/04")]

...
namespace JXTNext.Sitefinity.LoginStatusExtended.Mvc.StringResources
{
    ...
    public class LoginStatusExtendedResources : Resource
    {
        ...
        /// </summary>
        public LoginStatusExtendedResources()
        {
        }
        ...
        public LoginStatusExtendedResources(ResourceDataProvider dataProvider)
            : base(dataProvider)
        {
        }
        ...
        /// <summary>
        /// Gets phrase : User Job Alert page
        /// </summary>
        [ResourceEntry("JobAlertPage",
            Value = "User job alert page",
            Description = "phrase : User job alert page",
            LastModified = "2015/02/24")]
        public string JobAlertPage
        {
            get
            {
                return this["JobAlertPage"];
            }
        }

        /// <summary>
        /// Gets phrase : This is the page where you have dropped Job Alert widget
        /// </summary>
        [ResourceEntry("JobAlertPageInfo",
            Value = "This is the page where you have dropped Job Alert widget",
            Description = "phrase : This is the page where you have dropped Job Alert widget",
            LastModified = "2015/02/24")]
        public string JobAlertPageInfo
        {
            get
            {
                return this["JobAlertPageInfo"];
            }
        }

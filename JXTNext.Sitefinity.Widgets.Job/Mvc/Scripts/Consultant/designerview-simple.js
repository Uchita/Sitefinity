    ...
    angular.module('designer').controller('SimpleCtrl', ['$scope', 'propertyService', function ($scope, propertyService) {
        ...
        propertyService.get()
            .then(function (data) {
                ...
                if ($scope.properties.Sorting.PropertyValue === null || $scope.properties.Sorting.PropertyValue === 'undefined' || $scope.properties.Sorting.PropertyValue === '')
                    $scope.properties.Sorting.PropertyValue = 'Recent';

...
namespace JXTNext.Sitefinity.Widgets.JobAlert.Mvc.StringResources
{
    ...
    public class JobAlertResources : Resource
    {
        ...
        /// Gets phrase: Create button's label
        /// </summary>
        [ResourceEntry("SuccessCreateJobAlert",
            Value = "A Job Alert has been created successfully.",
            Description = "word : Success message for job alert",
            LastModified = "2019/05/16")]
        public string SuccessCreateJobAlert
        {
            get
            {
                return this["SuccessCreateJobAlert"];
            }
        }
        ...
        /// Gets phrase: Create button's label
        /// </summary>
        [ResourceEntry("SuccessUpdateJobAlert",
            Value = "A Job Alert has been updated successfully.",
            Description = "word : Success update message for job alert",
            LastModified = "2019/05/16")]
        public string SuccessUpdateJobAlert
        {
            get
            {
                return this["SuccessUpdateJobAlert"];
            }
        }
        ...
        /// Gets phrase: Create button's label
        /// </summary>
        [ResourceEntry("SuccessDeleteJobAlert",
            Value = "A Job Alert has been deleted successfully.",
            Description = "word : Success delete message for job alert",
            LastModified = "2019/05/16")]
        public string SuccessDeleteJobAlert
        {
            get
            {
                return this["SuccessDeleteJobAlert"];
            }
        }
        #endregion
    }

...
namespace JXTNext.Sitefinity.Widgets.Social.Mvc.Helpers
{
    public class LinkedInHelper
    {
        ...
        public static string CustomerClientId
        {
            get
            {
                var settings = new SiteSettingsHelper();

                return settings.GetCurrentSiteLinkedInCustomerClientId();
            }
        }
        ...
        public static string CustomerClientSecret
        {
            get
            {
                ...
                return settings.GetCurrentSiteLinkedInCustomerClientSecret();
            }
        }
        ...
        public static string CustomerIntegrationContext
        {
            get
            {
                ...
                return settings.GetCurrentSiteLinkedInCustomerIntegrationContext();
            }
        }
        ...
        public static string ClientId
        {
            get
            {
                ...
                return settings.GetCurrentSiteLinkedInClientId();
            }
        }
        ...
        public static string ClientSecret
        {
            get
            {
                ...
                return settings.GetCurrentSiteLinkedInClientSecret();
            }
        }
        ...
        public static string SocialHandlerUrl
        {
            get
            {
                ...
                var url = settings.GetCurrentSiteLinkedInSocialHandlerUrl();

...
/*
	...
	Important: Do not modify this file. Edit the file SqlAdvertiserJobTemplateLogoProvider.cs instead.
*/
...
namespace JXTPortal.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlAdvertiserJobTemplateLogoProviderBase : AdvertiserJobTemplateLogoProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlAdvertiserJobTemplateLogoProviderBase"/> instance.
		/// </summary>
		public SqlAdvertiserJobTemplateLogoProviderBase()
		{
		}
	...
	public SqlAdvertiserJobTemplateLogoProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _advertiserJobTemplateLogoId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@AdvertiserJobTemplateLogoId", DbType.Int32, _advertiserJobTemplateLogoId);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(AdvertiserJobTemplateLogo)
					,_advertiserJobTemplateLogoId);
		...
		public override TList<AdvertiserJobTemplateLogo> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<AdvertiserJobTemplateLogo>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@JobTemplateLogoUrl", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("joblogoname ") || clause.Trim().StartsWith("joblogoname="))
				{
					database.SetParameterValue(commandWrapper, "@JobLogoName", 
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of JXTPortal.Entities.AdvertiserJobTemplateLogo objects.</returns>
		public override TList<AdvertiserJobTemplateLogo> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_Find_Dynamic", typeof(AdvertiserJobTemplateLogoColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<AdvertiserJobTemplateLogo> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of JXTPortal.Entities.AdvertiserJobTemplateLogo objects.</returns>
		public override TList<AdvertiserJobTemplateLogo> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<AdvertiserJobTemplateLogo> GetByAdvertiserId(TransactionManager transactionManager, System.Int32 _advertiserId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_GetByAdvertiserId", _useStoredProcedure);
		...
		#region GetByAdvertiserJobTemplateLogoId
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override JXTPortal.Entities.AdvertiserJobTemplateLogo GetByAdvertiserJobTemplateLogoId(TransactionManager transactionManager, System.Int32 _advertiserJobTemplateLogoId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_GetByAdvertiserJobTemplateLogoId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@AdvertiserJobTemplateLogoId", DbType.Int32, _advertiserJobTemplateLogoId);
			
			IDataReader reader = null;
			TList<AdvertiserJobTemplateLogo> tmp = new TList<AdvertiserJobTemplateLogo>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAdvertiserJobTemplateLogoId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAdvertiserJobTemplateLogoId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<JXTPortal.Entities.AdvertiserJobTemplateLogo> entities)
		{
			...
			bulkCopy.DestinationTableName = "AdvertiserJobTemplateLogo";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("AdvertiserJobTemplateLogoID", typeof(System.Int32));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("AdvertiserID", typeof(System.Int32));
			col1.AllowDBNull = false;		
			DataColumn col2 = dataTable.Columns.Add("JobLogoName", typeof(System.String));
			...
			foreach(JXTPortal.Entities.AdvertiserJobTemplateLogo entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["AdvertiserJobTemplateLogoID"] = entity.AdvertiserJobTemplateLogoId;
							
				
					row["AdvertiserID"] = entity.AdvertiserId;
							
				
					row["JobLogoName"] = entity.JobLogoName;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, JXTPortal.Entities.AdvertiserJobTemplateLogo entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@AdvertiserJobTemplateLogoId", DbType.Int32, 4);
			...
			object _advertiserJobTemplateLogoId = database.GetParameterValue(commandWrapper, "@AdvertiserJobTemplateLogoId");
			entity.AdvertiserJobTemplateLogoId = (System.Int32)_advertiserJobTemplateLogoId;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, JXTPortal.Entities.AdvertiserJobTemplateLogo entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_Update", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@AdvertiserJobTemplateLogoId", DbType.Int32, entity.AdvertiserJobTemplateLogoId );
			database.AddInParameter(commandWrapper, "@AdvertiserId", DbType.Int32, entity.AdvertiserId );
			database.AddInParameter(commandWrapper, "@JobLogoName", DbType.String, entity.JobLogoName );
			database.AddInParameter(commandWrapper, "@JobTemplateLogo", DbType.Binary, entity.JobTemplateLogo );
			database.AddInParameter(commandWrapper, "@JobTemplateLogoUrl", DbType.String, entity.JobTemplateLogoUrl );
		...
		public override void Insert(TransactionManager transactionManager, int start, int pageLength , System.Int32? advertiserId, System.String jobLogoName, System.Byte[] jobTemplateLogo, System.String jobTemplateLogoUrl, ref System.Int32? advertiserJobTemplateLogoId)
		{
			...
			advertiserJobTemplateLogoId =  Utility.GetParameterValue<System.Int32?>(commandWrapper.Parameters["@AdvertiserJobTemplateLogoId"]);
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public override DataSet GetPagingByAdvertiserId(TransactionManager transactionManager, int start, int pageLength , System.Int32? advertiserId, System.Int32? pageSize, System.Int32? pageNumber)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_GetPagingByAdvertiserId", true);
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetPagingByAdvertiserId", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetPagingByAdvertiserId", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void Delete(TransactionManager transactionManager, int start, int pageLength , System.Int32? advertiserJobTemplateLogoId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AdvertiserJobTemplateLogo_Delete", true);

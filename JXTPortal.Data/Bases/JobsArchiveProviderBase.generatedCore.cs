...
{	
	...
	{		
		...
		/// <returns>Returns a typed collection of JXTPortal.Entities.JobsArchive objects.</returns>
		public TList<JobsArchive> GetByScreeningQuestionsTemplateId(System.Int32? _screeningQuestionsTemplateId)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of JXTPortal.Entities.JobsArchive objects.</returns>
		/// <remarks></remarks>
		public TList<JobsArchive> GetByScreeningQuestionsTemplateId(TransactionManager transactionManager, System.Int32? _screeningQuestionsTemplateId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of JXTPortal.Entities.JobsArchive objects.</returns>
		public TList<JobsArchive> GetByScreeningQuestionsTemplateId(TransactionManager transactionManager, System.Int32? _screeningQuestionsTemplateId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK__JobsArchi__Scree__78B7C69B key.
		///		fkJobsArchiScree78b7c69b Description: 
		/// </summary>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="_screeningQuestionsTemplateId"></param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of JXTPortal.Entities.JobsArchive objects.</returns>
		public TList<JobsArchive> GetByScreeningQuestionsTemplateId(System.Int32? _screeningQuestionsTemplateId, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of JXTPortal.Entities.JobsArchive objects.</returns>
		public TList<JobsArchive> GetByScreeningQuestionsTemplateId(System.Int32? _screeningQuestionsTemplateId, int start, int pageLength,out int count)
		{
			return GetByScreeningQuestionsTemplateId(null, _screeningQuestionsTemplateId, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of JXTPortal.Entities.JobsArchive objects.</returns>
		public abstract TList<JobsArchive> GetByScreeningQuestionsTemplateId(TransactionManager transactionManager, System.Int32? _screeningQuestionsTemplateId, int start, int pageLength, out int count);
		...
		public static TList<JobsArchive> Fill(IDataReader reader, TList<JobsArchive> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.ScreeningQuestionsTemplateId = (reader.IsDBNull(((int)JobsArchiveColumn.ScreeningQuestionsTemplateId - 1)))?null:(System.Int32?)reader[((int)JobsArchiveColumn.ScreeningQuestionsTemplateId - 1)];
		...
		public static void RefreshEntity(IDataReader reader, JXTPortal.Entities.JobsArchive entity)
		{
			...
			entity.ScreeningQuestionsTemplateId = (reader.IsDBNull(((int)JobsArchiveColumn.ScreeningQuestionsTemplateId - 1)))?null:(System.Int32?)reader[((int)JobsArchiveColumn.ScreeningQuestionsTemplateId - 1)];

USE [MiniJXT]
GO
/****** Object:  StoredProcedure [dbo].[ViewJobs_GetByID]    Script Date: 03/31/2017 11:13:03 ******/
SET ANSI_NULLS ON
GO
...
SELECT Jobs.[JobID]          
      ...
      ,ISNULL(SiteCountry.[Currency], '') AS CurrencySymbol  -- get from country currency symbol instead of currencies table ,Currencies.[CurrencySymbol]          
 ...
 USE [MiniJXT]
GO
/****** Object:  StoredProcedure [dbo].[ViewJobSearch_GetBySearchFilterRedefine]    Script Date: 03/31/2017 11:14:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

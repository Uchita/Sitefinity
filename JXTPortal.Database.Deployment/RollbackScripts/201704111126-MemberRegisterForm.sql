ALTER TABLE GlobalSettings DROP CONSTRAINT FK__GlobalSet__Membe__1A26D4BA
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Insert]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetPaged]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				END
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteIdUseAdvertiserFilter]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteIdPublicJobsSearch]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteIdGlobalSettingId]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteId]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteFavIconId]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByPublicJobsSearchPrivateJobsSiteId]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByLastModifiedBy]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByGlobalSettingId]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByDefaultLanguageId]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByDefaultDynamicPageId]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByDefaultCountryId]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Get_List]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Find]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
  ...
  END
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Delete]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				WHERE
					[GlobalSettingID] = @GlobalSettingId
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_CustomGetPaymentDetail]    Script Date: 04/19/2017 13:53:24 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER TABLE Sites DROP COLUMN SiteURLAlias
GO

ALTER TABLE GlobalSettings DROP CONSTRAINT FK__GlobalSet__JobAp__355AB93A
GO

ALTER TABLE GlobalSettings DROP COLUMN JobApplicationPageID
GO

DROP PROCEDURE GlobalSettings_GetByJobApplicationPageId
GO 

/****** Object:  StoredProcedure [dbo].[Sites_Update]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
...
[SiteID] = @SiteId
GO
/****** Object:  StoredProcedure [dbo].[Sites_Insert]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Sites_GetPaging]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Sites_GetPaged]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				END
GO
/****** Object:  StoredProcedure [dbo].[Sites_GetBySiteId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[Sites_GetByMobileUrl]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[Sites_GetByLastModifiedBy]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[Sites_Get_List]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[Sites_Find]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
  ...
  END
GO
/****** Object:  StoredProcedure [dbo].[Sites_Delete]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				WHERE
					[SiteID] = @SiteId
GO
/****** Object:  StoredProcedure [dbo].[Sites_FindSite]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[Sites_Create]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END TRY
		...
		END CATCH
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Update]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Insert]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetPaged]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				END
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteIdUseAdvertiserFilter]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteIdPublicJobsSearch]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteIdGlobalSettingId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteFavIconId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByPublicJobsSearchPrivateJobsSiteId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByMemberRegisterPageId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByLastModifiedBy]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByGlobalSettingId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByDefaultLanguageId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByDefaultDynamicPageId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetByDefaultCountryId]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Get_List]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				SELECT @@ROWCOUNT
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Find]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
  ...
  END
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_Delete]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
				...
				WHERE
					[GlobalSettingID] = @GlobalSettingId
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_CustomGetPaymentDetail]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Sites_Remove]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Sites_Copy]    Script Date: 04/20/2017 14:14:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

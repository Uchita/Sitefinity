USE [MiniJXT]
GO
/****** Object:  StoredProcedure [dbo].[ViewJobSearch_GetBySearchFilter]    Script Date: 04/10/2017 15:31:55 ******/
SET ANSI_NULLS ON
GO
...
BEGIN   
	...
	*/                
	...
	WHERE                                              
		...
		AND ((@SalaryLowerBandlocal = 0) OR (Jobs.SalaryLowerBand >= @SalaryLowerBandlocal)) 
		AND ((@SalaryUpperBandlocal = 0) OR (Jobs.SalaryUpperBand <= @SalaryUpperBandlocal)) 

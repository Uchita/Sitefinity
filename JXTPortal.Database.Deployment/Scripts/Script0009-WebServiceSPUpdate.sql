...
ConsultantID,                  
 ...
 UPDATE Jobs SET                  
  ...
  SiteID = @SiteID, WorkTypeID = WorkType, JobName = Title, [Description] = ShortDescription, FullDescription = #FlatXML.FullDescription,                      WebServiceProcessed = 1, ApplicationEmailAddress = ISNULL(#FlatXML.ApplicationEmailAddress,''),
 Visible = 1,                           

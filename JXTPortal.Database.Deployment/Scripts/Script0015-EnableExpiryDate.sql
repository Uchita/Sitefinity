ALTER TABLE GlobalSettings ADD EnableExpiryDate BIT NOT NULL DEFAULT 0
GO
...
AS
				...
				END
GO
/****** Object:  StoredProcedure [dbo].[GlobalSettings_GetBySiteIdUseAdvertiserFilter]    Script Date: 03/20/2017 17:00:59 ******/
SET ANSI_NULLS OFF
GO

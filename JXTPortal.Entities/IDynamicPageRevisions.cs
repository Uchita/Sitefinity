...
{
	/// <summary>
	///		The data structure representation of the 'DynamicPageRevisions' table via interface.
	/// </summary>
	/// <remarks>
	/// 	This struct is generated by a tool and should never be modified.
	/// </remarks>
	public interface IDynamicPageRevisions 
	{
		/// <summary>			
		/// DynamicPageRevisionID : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "DynamicPageRevisions"</remarks>
		System.Int32 DynamicPageRevisionId { get; set; }

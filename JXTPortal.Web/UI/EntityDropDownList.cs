    ...
    public class EntityDropDownList : DropDownList
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if ( !ReadOnly )
            {
                ...
                script.Append( "function " + functionName + " (e, dropdownlist,caseSensitive) {" + System.Environment.NewLine );
                ...
                script.Append( "  var key = String.fromCharCode((window.event)?window.event:e.which); " + System.Environment.NewLine );

<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master"
    AutoEventWireup="true" Inherits="Educations" Title="Members - Education List"
    CodeBehind="Educations.aspx.cs" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    Educations List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="3" border="0" class="grid" id="tblEducationRepeater">
        <asp:Repeater ID="rptEducation" runat="server" OnItemCommand="rptEducation_ItemCommand"
            OnItemDataBound="rptEducation_ItemDataBound">
            <HeaderTemplate>
                <thead>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="litEducationName" runat="server" />
                    </td>
                    <td>
    ...
    <br />
    <asp:Button runat="server" ID="btnEducations" OnClientClick="javascript:location.href='EducationsEdit.aspx'; return false;"

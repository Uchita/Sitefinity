<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileBrowser.aspx.cs" Inherits="JXTPortal.Website.Admin.FileBrowser" %>
        ...
        <div class="container-fluid" id="file-manager-bg">
            ...
            <asp:UpdatePanel ID="updatePanel" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <tr>
                    <td width="70%">
                    <JXTControl:FileManagerFiles ID="FileManagerFiles" runat="server" BrowserMode="True" />
                    </td>
                    <td width="30%">

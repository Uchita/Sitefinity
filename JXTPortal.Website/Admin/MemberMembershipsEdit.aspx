<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="True" Inherits="MemberMembershipsEdit" Title="MemberMemberships Edit" Codebehind="MemberMembershipsEdit.aspx.cs" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Member Memberships - Add/Edit</asp:Content>
        ...
        <ul class="form-section">
            <li class="form-line" id="reg-username-field">
                <label class="form-label-left">
                    Membership Name:<span class="form-required">*</span>
                </label>
                <div class="form-input">
                    <asp:TextBox ID="txtMembershipsName" runat="server" /><asp:RequiredFieldValidator
                        ID="ReqVal_MembershipsName" runat="server" Display="Dynamic" ControlToValidate="txtMembershipsName"

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/admin.Master" AutoEventWireup="true" CodeBehind="MultiLingualAdvertiserAccountType.aspx.cs" Inherits="JXTPortal.Website.Admin.MultiLingualAdvertiserAccountType" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    MultiLingual Advertiser Account Type - Add/Edit
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-all">
        ...
        <ul class="form-section">
            <li class="form-line" id="mlc-language-field">
                <label class="form-label-left">
                    Advertiser Account Type:<span class="form-required">*</span>
                </label>
        ...
        <asp:Repeater ID="rptMultiLingualAdvertiserAccountType" runat="server" OnItemDataBound="rptMultiLingualAdvertiserAccountType_ItemDataBound">
            <HeaderTemplate>
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        ...
                        <asp:HiddenField ID="hfAdvertiserAccountTypeID" runat="server" />
                    </td>
                    <td>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/admin.Master" AutoEventWireup="true" CodeBehind="MultiLingualAvailableStatus.aspx.cs" Inherits="JXTPortal.Website.Admin.MultiLingualAvailableStatus" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    MultiLingual AvailableStatus - Add/Edit
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-all">
        ...
        <ul class="form-section">
            <li class="form-line" id="mlc-language-field">
                <label class="form-label-left">
                    Available Status:<span class="form-required">*</span>
                </label>
        ...
        <asp:Repeater ID="rptMultiLingualAvailableStatus" runat="server" OnItemDataBound="rptMultiLingualAvailableStatus_ItemDataBound">
            <HeaderTemplate>
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        ...
                        <asp:HiddenField ID="hfAvailableStatusId" runat="server" />
                    </td>
                    <td>

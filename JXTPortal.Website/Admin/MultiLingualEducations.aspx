<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/admin.Master" AutoEventWireup="true" CodeBehind="MultiLingualEducations.aspx.cs" Inherits="JXTPortal.Website.Admin.MultiLingualEducations" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    MultiLingual Educations - Add/Edit
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-all">
        ...
        <asp:Repeater ID="rptMultiLingualEducations" runat="server" OnItemDataBound="rptMultiLingualEducations_ItemDataBound">
            <HeaderTemplate>
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        ...
                        <asp:HiddenField ID="hfEducationId" runat="server" />
                    </td>
                    <td>

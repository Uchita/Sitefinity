<%@ Page Title="MultiLingual Work Types" Language="C#" MasterPageFile="~/MasterPages/admin.Master"
    AutoEventWireup="true" CodeBehind="MultiLingualWorkType.aspx.cs" Inherits="JXTPortal.Website.Admin.MultiLingualWorkType" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    MultiLingual WorkType - Add/Edit
</asp:Content>
        ...
        <ul class="form-section">
            <li class="form-line" id="mlc-language-field">
                <label class="form-label-left">
                    WorkType:<span class="form-required">*</span>
                </label>
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        ...
                        <asp:HiddenField ID="hfWorkTypeId" runat="server" />
                    </td>
                    <td>

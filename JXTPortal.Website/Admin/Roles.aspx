<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master"
    AutoEventWireup="true" Inherits="Roles" Title="Global - Default Roles" CodeBehind="Roles.aspx.cs" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    Roles List</asp:Content>
        ...
        <ul class="form-section">
            <li class="form-line" id="country-field">
                ...
                <div class="form-input">
                    <asp:DropDownList ID="ddlProfession" runat="server" AutoPostBack="true" CssClass="form-multiple-column"
...
<span class="form-message">
        ...
        <asp:Repeater ID="rptRoles" runat="server" OnItemDataBound="rptRoles_ItemDataBound">
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        <a href='RolesEdit.aspx?RoleId=<%# Eval("RoleId") %>'>Select</a>
                    </td>
                    <td scope="col">
                        <asp:Literal ID="ltRoleName" runat="server" />
                    </td>
                    <td scope="col">

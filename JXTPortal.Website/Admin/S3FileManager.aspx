<%@ Page Title="File Manager" Language="C#" MasterPageFile="~/MasterPages/admin.Master"
    AutoEventWireup="true" CodeBehind="S3FileManager.aspx.cs" Inherits="JXTPortal.Website.Admin.S3FileManager"
                            ...
                            <table cellpadding="0" cellspacing="0" border="none" class="filemanager-holder-tble">
                                <tr>
                                    ...
                                    <td width="75%" valign="top" align="left">
                                        <JXTControl:S3FileManagerFiles ID="FileManagerFiles" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </div>

<%@ Control Language="C#" ClassName="JobsFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataJobTemplateId" runat="server" Text="Job Template Id:" AssociatedControlID="dataJobTemplateId" /></td>
        <td>
					<data:EntityDropDownList runat="server" ID="dataJobTemplateId" DataSourceID="JobTemplateIdJobTemplatesDataSource" DataTextField="JobTemplateParentId" DataValueField="JobTemplateId" SelectedValue='<%# Bind("JobTemplateId") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
					<data:JobTemplatesDataSource ID="JobTemplateIdJobTemplatesDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>

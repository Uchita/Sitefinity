<%@ Control Language="C#" ClassName="MemberMembershipsFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataMemberMembershipsName" runat="server" Text="Member Memberships Name:" AssociatedControlID="dataMemberMembershipsName" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataMemberMembershipsName" Text='<%# Bind("MemberMembershipsName") %>'  TextMode="MultiLine"  Width="250px" Rows="5"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataMemberMembershipsName" runat="server" Display="Dynamic" ControlToValidate="dataMemberMembershipsName" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>

<%@ Control Language="C#" ClassName="ProfessionFields" %>

<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
		<table border="0" cellpadding="3" cellspacing="1">
			<tr>
        <td class="literal"><asp:Label ID="lbldataProfessionName" runat="server" Text="Profession Name:" AssociatedControlID="dataProfessionName" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataProfessionName" Text='<%# Bind("ProfessionName") %>'  TextMode="MultiLine"  Width="250px" Rows="5"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataProfessionName" runat="server" Display="Dynamic" ControlToValidate="dataProfessionName" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>

...
{
    public partial class AdvertiserTypeStatistics : System.Web.UI.Page
    {
        #region Declarations
        ...
        private void LoadAdvertiserTypeStatistics()
        {
            gvAdvertiserTypeStatistics.DataSource = AdvertisersService.GetAdvertiserTypeStatistics(_siteID);
            gvAdvertiserTypeStatistics.DataBind();
        }

...
{
    public partial class AllJobStatistics : System.Web.UI.Page
    {
        #region Declarations
        ...
        private void LoadAllJobStatistics()
        {
            gvAllJobStatistics.DataSource = AdvertisersService.GetAllJobStatistics(_siteID);
            gvAllJobStatistics.DataBind();
        }
        #endregion

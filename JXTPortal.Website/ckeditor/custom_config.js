...
CKEDITOR.editorConfig = function (config) {
    ...
    if (location.href.toLowerCase().indexOf("/admin/") > -1) {
        config.filebrowserBrowseUrl = "/Admin/FileBrowser.aspx";
        config.filebrowserImageBrowseUrl = "/Admin/FileBrowser.aspx?type=Image";
        config.filebrowserImageBrowseLinkUrl = "/Admin/FileBrowser.aspx";
    }

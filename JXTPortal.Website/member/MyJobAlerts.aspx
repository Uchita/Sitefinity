<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomMain.Master" AutoEventWireup="true"
    CodeBehind="MyJobAlerts.aspx.cs" Inherits="JXTPortal.Website.members.MyJobAlerts" %>
<%@ Register Src="~/usercontrols/member/ucMemberJobAlert.ascx" TagName="ucMemberJobAlert" TagPrefix="uc1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content">  
        <div class="content-holder">
            ...
            <JXTControl:ucSystemDynamicPage ID="ucSystemDynamicPage" runat="server" SetSystemPageCode="SystemPage_MemberJobAlert" />
            <asp:Literal ID="litSuccess" runat="server" />
            <asp:Button ID="btnCreateJobAlert" runat="server" CssClass="mini-new-buttons" OnClick="btnCreateJobAlert_Click" />
            <uc1:ucMemberJobAlert ID="ucMemberJobAlert" runat="server" CssClass="mini-new-buttons"/>
        </div>
    </div>
    </div>

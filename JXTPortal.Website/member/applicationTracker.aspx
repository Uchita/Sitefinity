<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomMain.Master" AutoEventWireup="true" CodeBehind="applicationTracker.aspx.cs" Inherits="JXTPortal.Website.member.applicationTracker" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-holder">
       ...
       <JXTControl:ucSystemDynamicPage ID="ucSystemDynamicPage" runat="server" SetSystemPageCode="SystemPage_MemberApplicationTracker" />
       <JXTControl:MemberApplicationTracker ID="ucMemberApplicationTracker" runat="server" IsAdmin="false" />
    </div>
    </div>
    </div>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- This field will be populated with ExternalMemberID field of Member entity -->
    <asp:HiddenField ID="hfExternalMemberID" ClientIDMode="Static" runat="server" />
            ...
            <div class="content-holder">
                ...
                <div id="CV-content">
                    <h1 class="CV-Builder-title">
                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral11" runat="server" SetLanguageCode="LabelDashboard" />
                    </h1>
                    <div class="row member-dashboard-content">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="db_section-content">
                                            <div id="box-profile-info">
                                                ...
                                                <h2 class="member-dashboard-candidatename"><small>
                                                    <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral14" runat="server" SetLanguageCode="LabelHi" />
                                                    , </small><span class="first-name">
                                                        <asp:Literal ID="ltlFirstName" runat="server" /></span>
                                                    <span class="last-name">
                                                        <asp:Literal ID="ltlLastName" runat="server" /></span></h2>
                                                <div id="headline">
                                                    <p class="highlight">
                                                        <asp:Literal ID="ltlHeadline" runat="server" />
                                                    </p>
                                                </div>
                                                <div class="row">
                                                ...
                                                <h5><strong>
                                                    <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral12" runat="server" SetLanguageCode="LabelWhatAreYouUpTo" />
                                                </strong></h5>
                                                <div class="profile-completion-info">
                                                    <span class="jxt_dash-statusInfo status-yes"><span class="fa fa-check"></span>
                                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral17" runat="server" SetLanguageCode="LabelRegistration" />
                                                    </span>
                                                    <span class="jxt_dash-statusInfo status-yes"><span class="fa fa-check"></span>
                                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral18" runat="server" SetLanguageCode="LabelValidation" />
                                                    </span>
                                                ...
                                                <asp:PlaceHolder runat="server" ID="phProfileStatusWidget" Visible="false">
                                                    <h5 class="text-incomplete"><strong>
                                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral99" runat="server" SetLanguageCode="LabelRequiredProfileSectionsHeading" />
                                                    </strong></h5>
                                    ...
                                    <div class="col-sm-6">
                                        <div id="box-profile-status">
                                            <div class="db_section-content">
                                                <h2>
                                                    <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral13" runat="server" SetLanguageCode="LabelHowDoesMyProfileCompare" />
                                                </h2>
                                                ...
                                                <div class="button-wrapper text-center">
                                                    <a href="/member/profile.aspx" class="btn btn-sm btn-primary"><span class="fa fa-edit"></span>
                                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral16" runat="server" SetLanguageCode="LabelEditProfile" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="form-section clearfix" id="box-profile-details">
                                <header class="db_section-header">
                                    <h2><span class="fa fa-info-circle">
                                        <!-- info icon -->
                                    </span>
                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral2" runat="server" SetLanguageCode="LabelMyDetails" />
                                    </h2>
                                </header>
                                <div class="db_section-content">
                                    <span class="highlight">
                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral3" runat="server" SetLanguageCode="LabelEmailAddress" />
                                    </span>
                                    <span class="personal-detail-content primary-email">
                                        <asp:Literal ID="ltlEmailAddress" runat="server" /></span>
                                    <asp:Literal ID="ltlPhone" runat="server" />
                                    <asp:Literal ID="ltlDOB" runat="server" />
                                    <span class="highlight address-detail-title">
                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral4" runat="server" SetLanguageCode="LabelAddress" />
                                    </span>
                                    <span class="personal-detail-content address-detail">
                                        <asp:Literal ID="ltlAddress" runat="server" /></span>
                                    <a href="/member/profile.aspx?focus=personal" class="btn btn-sm btn-primary"><span class="fa fa-edit"></span>
                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral15" runat="server" SetLanguageCode="LabelEditDetails" />
                                    </a>
                                </div>
                            </section>
                        </div>
                            ...
                            <section class="form-section clearfix">
                                ...
                                <asp:UpdatePanel ID="updatePanel" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <header class="db_section-header">
                                            <h2><span class="fa fa-save highlight">
                                                <!-- save icon -->
                                            </span>
                                                <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral5" runat="server" SetLanguageCode="LabelMySavedJobs" />
                                            </h2>
                                        </header>
                                        <div class="db_section-content">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="action-head">
                                                                <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral1" runat="server" SetLanguageCode="LabelAction" />
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <p>
                                                                            <asp:Literal ID="ltlSavedJobsName" runat="server" />
                                                                        </p>
                                                                    </td>
                                                                    ...
                                                                    <td class="action-cell">
                                                                        <asp:HyperLink ID="hlViewSavedJobs" runat="server" CssClass="btn btn-sm btn-primary">
                                                                            <asp:Literal ID="ltViewSavedJobs" runat="server" />
                                                                        </asp:HyperLink>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="form-section clearfix">
                                ...
                                <header class="db_section-header">
                                    <h2><span class="fa fa-bar-chart highlight">
                                        <!-- chart icon -->
                                    </span>
                                        <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral6" runat="server" SetLanguageCode="LabelJobApplicationDetails" />
                                    </h2>
                                </header>
                                <div class="db_section-content">
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rptMemberApplicationTracker" runat="server" OnItemDataBound="rptMemberApplicationTracker_ItemDataBound">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:HyperLink runat="server" ID="hypJobUrl" /></td>
                                                            <td>
                                                                <asp:Literal ID="ltDateApplied" runat="server" /></td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </tbody>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="form-section clearfix">
                                ...
                                <asp:UpdatePanel ID="updatePanel1" runat="server">
                                    <ContentTemplate>
                                        <header class="db_section-header">
                                            <h2><span class="fa fa-star-o highlight">
                                                <!-- start icon -->
                                            </span>
                                                <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral7" runat="server" SetLanguageCode="LabelFavouriteSearches" />
                                                /
                                                <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral8" runat="server" SetLanguageCode="LabelMyJobAlerts" />
                                            </h2>
                                        </header>
                                        <div class="db_section-content">
                                            <div id="memberBroadcast-JobAlert">
                                                <table id="box-table-alerts" class="box-table table table-hover table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                                <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral9" runat="server" SetLanguageCode="LabelJobTitle" />
                                                            </th>
                                                            <th class="action-edit">&nbsp;</th>
                                                            <th class="action-head">
                                                                <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral10" runat="server" SetLanguageCode="LabelSendEmailAlerts" />
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="action-cell">
                                                                        <label class="switch switch-flat">
                                                                            ...
                                                                            <span class="hidden">
                                                                                <JXTControl:ucLanguageLiteral ID="UcLanguageLiteral10" runat="server" SetLanguageCode="LabelYes" />
                                                                            </span>
                                                                        </label>
                                                                    </td>
                                                                </tr>

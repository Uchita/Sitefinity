    ...
    public class SocialLinkModel
    {
        public SocialLinkModel()
        {
            if (string.IsNullOrWhiteSpace(this.SerializedSocialLinks))
            {
                ...
                this.SerializedSocialLinks = JsonSerializer.SerializeToString<List<SocialViewModel>>(socialLinks);
            }
        }

        public List<SocialViewModel> GetViewModel()
        {
            var socialLinks = JsonSerializer.DeserializeFromString<List<SocialViewModel>>(this.SerializedSocialLinks);

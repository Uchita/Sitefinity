...
namespace SitefinityWebApp.Helpers
{
    public static class ContentHelper
    {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetLastInsight"))
            {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetFeaturedArticleNavigation"))
            {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetFeaturedArticle"))
            {
                var cultureInfo = Thread.CurrentThread.CurrentUICulture;
                if (cultureInfo.IsNeutralCulture)
                {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetBestArticleUrl"))
            {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetArticles"))
            {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.FilterByFlatTaxonName"))
            {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetRelatedDynamicContentItemsByHierarchicalTaxonomy"))
            {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetSortExpression"))
            {
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetSortParameter"))
            {
                string orderByValue = HttpContext.Current.Request.QueryString["orderby"];
        ...
        {
            using (new StatsDPerformanceMeasure("ContentHelper.GetItemsPagingInfo"))
            {

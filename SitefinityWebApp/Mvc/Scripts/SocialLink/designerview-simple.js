(function ($) {
    ...
    angular.module('designer').controller('SimpleCtrl', ['$scope', 'propertyService', function ($scope, propertyService) {
        ...
        $scope.$watch('list', function (list) {
            $scope.properties.SerializedSocialLinks.PropertyValue = angular.toJson(list, true);
        }, true);
        ...
        propertyService.get()
            .then(function (data) {
                ...
                $scope.list = $.parseJSON($scope.properties.SerializedSocialLinks.PropertyValue);
            });
    }]);
})(jQuery);